...
namespace future
{
    ...
    namespace priv
    {
        struct StateBase : SharedObj
        {
            ...
            StateBase(Alloc&& a)                                : SharedObj(forward<Alloc>(a)), e(nullptr), ready(false), futureRetrieved(false) {}
            ...
            void setException(const Exception& e_, bool setReady = true)
            {
            ...
            // std::function is not used here to avoid the operator() virtual call. Functors must delete themselves after running.
        ...
        struct State : StateBase
        {
            ...
            Storage _storage;
            #ifndef FINAL
                /// Make result visible in debugger
                R& _result;
            #endif
        };
