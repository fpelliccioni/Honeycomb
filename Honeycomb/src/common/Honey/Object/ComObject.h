...
private:
    ...
    void removeComInSlot(SlotMap::iterator& slotIt, Slot::List::iterator it, bool removeDeps, bool eraseSlot = true);
    void removeComsInSlot(SlotMap::iterator slotIt, bool removeDeps, bool eraseSlot = true);
