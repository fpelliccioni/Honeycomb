...
/**
  ...
  *     Real mass = Vegas(Func(), Salsa(), Vegas::Vec(-2), Vegas::Vec(2)).integrate();
  *     //mass =~ 16.7
  *
...
public:
    ...
    /// Get chi-square statistic for integral.  A value that differs significantly from 1 (ex. diff > 0.5) indicates an unreliable result and more samples or iterations are required.
