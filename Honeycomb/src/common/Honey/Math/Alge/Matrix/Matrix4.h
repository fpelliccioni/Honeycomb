...
public:
    ...
    Matrix inverse(option<Real&> det = optnull) const;
    ...
    /**
      ...
      * /see fromTrs()
      */
    void decompose( option<Vec3&> trans = optnull, option<Quat&> rot = optnull,
                    option<Vec3&> scale = optnull, option<Quat&> skew = optnull) const;
...
private:
    ...
    void decomposeSkew( option<Vec3&> trans, option<Quat&> rot,
