...
public:
    ...
    template<class T, int = T::s_cols /*TODO: msvc crash*/>
    ...
    Matrix<s_cols, s_rows, Real> inverse(option<Real&> det = optnull) const
    {
    ...
    /// To string
    friend StringStream& operator<<(StringStream& os, const MatrixBase& mat)
    {
