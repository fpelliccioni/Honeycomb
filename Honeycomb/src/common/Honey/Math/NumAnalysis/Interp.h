...
public:
    ...
    static Real linearAngle(Real t, Real angleStart, Real angleEnd, option<int&> rotSign = optnull);
    ...
    static void alignDir(Vec3& dir, const Vec3& targetDir, Real angleAmount, option<int&> rotSign = optnull);
