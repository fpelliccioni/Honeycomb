// Honeycomb, Copyright (C) 2012 Daniel Carter.  Distributed under the Boost Software License v1.0.
#pragma hdrstop

#define Component_reg
#include "Editor/Core/Main.h"
#include "../../../Honeycomb/Test/Test.h"
                     ...
                     int       nCmdShow)
{
    ...
    LoadString(hInstance, IDC_EDITOR, windowClass, MAX_LOADSTRING);
